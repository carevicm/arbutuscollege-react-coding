...
all tests pass when running npm test in the task_1/dashboard directory
...
Please review your task manually with the following checklist
all tests in task_2/dashboard/ pass
...
Please review your task manually with the following checklist
When running the task_3 react app using npm start, you should see each notification item disappear when you click on each individual item in the panel of notifications.
...
Please review your task manually with the following checklist
in task_4/dashboard/src/CourseList/CourseListRow.js, checkbox of each row is correctly checked/unchecked after user interaction
