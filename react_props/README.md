...
checks that it contains 1 Notifications component (1 point)
...
Please review your task manually with the following checklist
File: task_2/dashboard/src/Notifications/Notifications.test.js
...
Please review your task manually with the following checklist
File: task_4/dashboard/src/Notifications/Notifications.test.js

exists and is not empty (0 points)
has check that the menu item is being displayed when displayDrawer is false (1 point)
...
Please review your task manually with the following checklist
File: task_5/dashboard/src/CourseList/CourseList.test.js

exists and is not empty (0 points)
Tests correct render of CourseList when passing an empty listCourses (1 point)
Tests correct render of CourseList when passing a non empty listCourses (1 point)
